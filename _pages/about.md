...
I'm Isaac, an iOS engineer in Brooklyn, NY, originally from [Bridgeport, CT](https://en.wikipedia.org/wiki/Bridgeport,_Connecticut). I've been building iOS apps for about twelve years, most recently at Block on Square's point of sale, and before that at Twitter, JOOR, and Survey Sampling International. Along the way I've worked across the stack too: frontend, backend, and Android.
